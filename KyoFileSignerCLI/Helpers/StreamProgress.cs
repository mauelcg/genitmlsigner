namespace KyoFileSignerCLI.Helpers
{
    class StreamProgress : Stream
    {
        ...
        public StreamProgress(Stream stream, IProgress<int> readProgress, IProgress<int> writeProgress)
        {
            _stream = stream;
